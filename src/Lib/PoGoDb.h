...
static const std::array<PokemonSpecie, 386> PokemonByNumber{{
    { 1, 118, 118, 90, "BULBASAUR", PokemonType::GRASS, PokemonType::POISON, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 2, 151, 151, 120, "IVYSAUR", PokemonType::GRASS, PokemonType::POISON, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 3, 198, 198, 160, "VENUSAUR", PokemonType::GRASS, PokemonType::POISON, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 4, 116, 96, 78, "CHARMANDER", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 5, 158, 129, 116, "CHARMELEON", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 6, 223, 176, 156, "CHARIZARD", PokemonType::FIRE, PokemonType::FLYING, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 7, 94, 122, 88, "SQUIRTLE", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 8, 126, 155, 118, "WARTORTLE", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 9, 171, 210, 158, "BLASTOISE", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    ...
    { 29, 86, 94, 110, "NIDORAN_FEMALE", PokemonType::POISON, PokemonType::NONE, PokemonRarity::NORMAL, 3, 0, 100 },
    { 30, 117, 126, 140, "NIDORINA", PokemonType::POISON, PokemonType::NONE, PokemonRarity::NORMAL, 3, 0, 100 },
    { 31, 180, 174, 180, "NIDOQUEEN", PokemonType::POISON, PokemonType::GROUND, PokemonRarity::NORMAL, 3, 0, 100 },
    { 32, 105, 76, 92, "NIDORAN_MALE", PokemonType::POISON, PokemonType::NONE, PokemonRarity::NORMAL, 3, 100, 0 },
    { 33, 137, 112, 122, "NIDORINO", PokemonType::POISON, PokemonType::NONE, PokemonRarity::NORMAL, 3, 100, 0 },
    { 34, 204, 157, 162, "NIDOKING", PokemonType::POISON, PokemonType::GROUND, PokemonRarity::NORMAL, 3, 100, 0 },
    { 35, 107, 116, 140, "CLEFAIRY", PokemonType::FAIRY, PokemonType::NONE, PokemonRarity::NORMAL, 1, 25, 75 },
    { 36, 178, 171, 190, "CLEFABLE", PokemonType::FAIRY, PokemonType::NONE, PokemonRarity::NORMAL, 1, 25, 75 },
    { 37, 96, 122, 76, "VULPIX", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 25, 75 },
    { 38, 169, 204, 146, "NINETALES", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 25, 75 },
    { 39, 80, 44, 230, "JIGGLYPUFF", PokemonType::NORMAL, PokemonType::FAIRY, PokemonRarity::NORMAL, 1, 25, 75 },
    { 40, 156, 93, 280, "WIGGLYTUFF", PokemonType::NORMAL, PokemonType::FAIRY, PokemonRarity::NORMAL, 1, 25, 75 },
    ...
    { 58, 136, 96, 110, "GROWLITHE", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    { 59, 227, 166, 180, "ARCANINE", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    ...
    { 63, 195, 103, 50, "ABRA", PokemonType::PSYCHIC, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    { 64, 232, 138, 80, "KADABRA", PokemonType::PSYCHIC, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    { 65, 271, 194, 110, "ALAKAZAM", PokemonType::PSYCHIC, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    { 66, 137, 88, 140, "MACHOP", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    { 67, 177, 130, 160, "MACHOKE", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    { 68, 234, 162, 180, "MACHAMP", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    ...
    { 106, 224, 211, 100, "HITMONLEE", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 5, 100, 0 },
    { 107, 193, 212, 100, "HITMONCHAN", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 5, 100, 0 },
    ...
    { 113, 60, 176, 500, "CHANSEY", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 5, 0, 100 },
    { 114, 183, 205, 130, "TANGELA", PokemonType::GRASS, PokemonType::NONE, PokemonRarity::NORMAL, 3, 50, 50 },
    { 115, 181, 165, 210, "KANGASKHAN", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 3, 0, 100 },
    ...
    { 124, 223, 182, 130, "JYNX", PokemonType::ICE, PokemonType::PSYCHIC, PokemonRarity::NORMAL, 5, 0, 100 },
    { 125, 198, 173, 130, "ELECTABUZZ", PokemonType::ELECTRIC, PokemonType::NONE, PokemonRarity::NORMAL, 5, 75, 25 },
    { 126, 206, 169, 130, "MAGMAR", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 5, 75, 25 },
    { 127, 238, 197, 130, "PINSIR", PokemonType::BUG, PokemonType::NONE, PokemonRarity::NORMAL, 5, 50, 50 },
    { 128, 198, 197, 150, "TAUROS", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 3, 100, 0 },
    ...
    { 133, 104, 121, 110, "EEVEE", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 134, 205, 177, 260, "VAPOREON", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 135, 232, 201, 130, "JOLTEON", PokemonType::ELECTRIC, PokemonType::NONE, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 136, 246, 204, 130, "FLAREON", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 137, 153, 139, 130, "PORYGON", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 3, 0, 0 },
    { 138, 155, 174, 70, "OMANYTE", PokemonType::ROCK, PokemonType::WATER, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 139, 207, 227, 140, "OMASTAR", PokemonType::ROCK, PokemonType::WATER, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 140, 148, 162, 60, "KABUTO", PokemonType::ROCK, PokemonType::WATER, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 141, 220, 203, 120, "KABUTOPS", PokemonType::ROCK, PokemonType::WATER, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 142, 221, 164, 160, "AERODACTYL", PokemonType::ROCK, PokemonType::FLYING, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 143, 190, 190, 320, "SNORLAX", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    ...
    { 152, 92, 122, 90, "CHIKORITA", PokemonType::GRASS, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 153, 122, 155, 120, "BAYLEEF", PokemonType::GRASS, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 154, 168, 202, 160, "MEGANIUM", PokemonType::GRASS, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 155, 116, 96, 78, "CYNDAQUIL", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 156, 158, 129, 116, "QUILAVA", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 157, 223, 176, 156, "TYPHLOSION", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 158, 117, 116, 100, "TOTODILE", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 159, 150, 151, 130, "CROCONAW", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 160, 205, 197, 170, "FERALIGATR", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    ...
    { 173, 75, 91, 100, "CLEFFA", PokemonType::FAIRY, PokemonType::NONE, PokemonRarity::NORMAL, 1, 25, 75 },
    { 174, 69, 34, 180, "IGGLYBUFF", PokemonType::NORMAL, PokemonType::FAIRY, PokemonRarity::NORMAL, 1, 25, 75 },
    { 175, 67, 116, 70, "TOGEPI", PokemonType::FAIRY, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 176, 139, 191, 110, "TOGETIC", PokemonType::FAIRY, PokemonType::FLYING, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    ...
    { 196, 261, 194, 130, "ESPEON", PokemonType::PSYCHIC, PokemonType::NONE, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 197, 126, 250, 190, "UMBREON", PokemonType::DARK, PokemonType::NONE, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    ...
    { 209, 137, 89, 120, "SNUBBULL", PokemonType::FAIRY, PokemonType::NONE, PokemonRarity::NORMAL, 3, 25, 75 },
    { 210, 212, 137, 180, "GRANBULL", PokemonType::FAIRY, PokemonType::NONE, PokemonRarity::NORMAL, 3, 25, 75 },
    ...
    { 222, 118, 156, 110, "CORSOLA", PokemonType::WATER, PokemonType::ROCK, PokemonRarity::NORMAL, 3, 25, 75 },
    ...
    { 236, 64, 64, 70, "TYROGUE", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 5, 100, 0 },
    { 237, 173, 214, 100, "HITMONTOP", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 5, 100, 0 },
    { 238, 153, 116, 90, "SMOOCHUM", PokemonType::ICE, PokemonType::PSYCHIC, PokemonRarity::NORMAL, 5, 0, 100 },
    { 239, 135, 110, 90, "ELEKID", PokemonType::ELECTRIC, PokemonType::NONE, PokemonRarity::NORMAL, 5, 75, 25 },
    { 240, 151, 108, 90, "MAGBY", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 5, 75, 25 },
    { 241, 157, 211, 190, "MILTANK", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 5, 0, 100 },
    { 242, 129, 229, 510, "BLISSEY", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 5, 0, 100 },
    ...
    { 252, 124, 104, 80, "TREECKO", PokemonType::GRASS, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 253, 172, 130, 100, "GROVYLE", PokemonType::GRASS, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 254, 223, 180, 140, "SCEPTILE", PokemonType::GRASS, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 255, 130, 92, 90, "TORCHIC", PokemonType::FIRE, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 256, 163, 115, 120, "COMBUSKEN", PokemonType::FIRE, PokemonType::FIGHTING, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 257, 240, 141, 160, "BLAZIKEN", PokemonType::FIRE, PokemonType::FIGHTING, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 258, 126, 93, 100, "MUDKIP", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 259, 156, 133, 140, "MARSHTOMP", PokemonType::WATER, PokemonType::GROUND, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 260, 208, 175, 200, "SWAMPERT", PokemonType::WATER, PokemonType::GROUND, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    ...
    { 296, 99, 54, 144, "MAKUHITA", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    { 297, 209, 114, 288, "HARIYAMA", PokemonType::FIGHTING, PokemonType::NONE, PokemonRarity::NORMAL, 3, 75, 25 },
    { 298, 36, 71, 100, "AZURILL", PokemonType::NORMAL, PokemonType::FAIRY, PokemonRarity::NORMAL, 3, 25, 75 },
    { 299, 82, 236, 60, "NOSEPASS", PokemonType::ROCK, PokemonType::NONE, PokemonRarity::NORMAL, 3, 50, 50 },
    { 300, 84, 84, 100, "SKITTY", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 3, 25, 75 },
    { 301, 132, 132, 140, "DELCATTY", PokemonType::NORMAL, PokemonType::NONE, PokemonRarity::NORMAL, 3, 25, 75 },
    ...
    { 313, 143, 171, 130, "VOLBEAT", PokemonType::BUG, PokemonType::NONE, PokemonRarity::NORMAL, 3, 100, 0 },
    { 314, 143, 171, 130, "ILLUMISE", PokemonType::BUG, PokemonType::NONE, PokemonRarity::NORMAL, 3, 0, 100 },
    ...
    { 345, 105, 154, 132, "LILEEP", PokemonType::ROCK, PokemonType::GRASS, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 346, 152, 198, 172, "CRADILY", PokemonType::ROCK, PokemonType::GRASS, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 347, 176, 100, 90, "ANORITH", PokemonType::ROCK, PokemonType::BUG, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    { 348, 222, 183, 150, "ARMALDO", PokemonType::ROCK, PokemonType::BUG, PokemonRarity::NORMAL, 3, 87.5, 12.5 },
    ...
    { 369, 162, 234, 200, "RELICANTH", PokemonType::WATER, PokemonType::ROCK, PokemonRarity::NORMAL, 5, 87.5, 12.5 },
    { 370, 81, 134, 86, "LUVDISC", PokemonType::WATER, PokemonType::NONE, PokemonRarity::NORMAL, 3, 25, 75 },
    ...
    { 380, 228, 268, 160, "LATIAS", PokemonType::DRAGON, PokemonType::PSYCHIC, PokemonRarity::LEGENDARY, 20, 0, 100 },
    { 381, 268, 228, 160, "LATIOS", PokemonType::DRAGON, PokemonType::PSYCHIC, PokemonRarity::LEGENDARY, 20, 100, 0 },
